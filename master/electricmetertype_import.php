<?php
/* ==============================================
   master/electricmetertype_import.php
   รับไฟล์ Excel (.xlsx) แล้วนำเข้าข้อมูลประเภทมิเตอร์ไฟฟ้า
...
/* ===== Helper: generate รหัสอัตโนมัติ รูปแบบ VT-0001 (เหมือนใน electricmetertype_save.php) ===== */
...
$res = sqlsrv_query($conn, "SELECT TypeName FROM CFP_ElectricMeterType");
$existingNames = array();
...
logImportResult($conn, 'CFP_ElectricMeterType', $fileName, $totalRows, $successCount, $failCount, $skipCount, $errors);

if ($successCount > 0) {
    logAction($conn, 'DATA_IMPORT', 'CFP_ElectricMeterType', null, null, null, null,

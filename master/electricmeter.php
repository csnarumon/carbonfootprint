        ...
        <table id="tblEM" class="table table-bordered table-hover align-middle" style="width:100%;font-size:0.85rem">
            <thead>
                <tr>
                    ...
                    <th style="width:120px">แหล่งไฟฟ้า</th>
                    <th style="width:90px">แรงดัน</th>
            ...
            <tbody>
                ...
                <tr data-status="<?php echo $r['IsActive'] ? 'ใช้งาน' : 'ปิด'; ?>"
                    ...
                    <td><?php echo htmlspecialchars($r['ESourceName']??'—'); ?></td>
                    <td style="font-size:0.8rem"><?php if($r['Voltage']){echo $r['Voltage'].'V';} if($r['Phase']){echo ' '.$r['Phase'].'φ';} if(!$r['Voltage']&&!$r['Phase'])echo '—'; ?></td>

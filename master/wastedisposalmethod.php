          ...
          <table id="tblType" class="table table-bordered table-hover align-middle" style="width:100%">
            ...
            <tbody>
              ...
              <tr data-status="<?php echo $r['IsActive'] ? '1' : '0'; ?>">
                <td><?php echo $i + 1; ?></td>
                <td><code><?php echo htmlspecialchars($r['MethodCode']); ?></code></td>
                <td><?php echo htmlspecialchars($r['MethodName']); ?></td>
...
<div class="modal fade" id="modalType" tabindex="-1" data-bs-backdrop="static">
  ...
  <input type="text" class="form-control font-prompt" name="MethodCode" id="fCode"
         placeholder="เช่น WDM-1001" maxlength="20" required>
</div>
            <div class="col-md-7">
...
คอลัมน์: รหัส*, ชื่อ*, คำอธิบาย, ลำดับ (รหัสต้องกรอกเอง)
</p>
          ...
          <div class="mt-2" style="font-size:0.78rem;color:var(--cfp-text-muted);">
            ...
            <ul class="mb-0 ps-3">
             ...
             <li>ต้องกรอกรหัสในไฟล์ (ห้ามเว้นว่าง) ระบบจะไม่สร้างรหัสให้อัตโนมัติ<!-- Badge สีส้ม  -->

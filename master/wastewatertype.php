...
<div class="modal fade" id="modalType" tabindex="-1" data-bs-backdrop="static">
  ...
  <input type="text" class="form-control font-prompt" name="TypeCode" id="fCode"
         placeholder="เช่น DOMESTIC, INDUSTRIAL" maxlength="50" required>
</div>
            <div class="col-md-7">
      ...
      <form id="formImport" method="POST" action="wastewatertype_import.php" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="cfp-import-dropzone" id="dropZone" onclick="document.getElementById('importFile').click()">
            ...
            <p style="font-size:0.72rem;color:var(--cfp-text-muted);">คอลัมน์: รหัส*, ชื่อ*, คำอธิบาย, ลำดับ</p>
          ...
          <div class="mt-2" style="font-size:0.78rem;color:var(--cfp-text-muted);">
            ...
            <ul class="mb-0 ps-3">
              ...
              <li>รหัสที่ใช้งานได้: DOMESTIC, INDUSTRIAL, AGRICULTURAL, MUNICIPAL, etc.</li>
            </ul>
          </div>

<?php
/* ==============================================
   master/flourwastetype_import.php
   รับไฟล์ Excel (.xlsx) แล้วนำเข้าข้อมูลประเภทการกำจัดเศษแป้ง
...
/* ===== Helper: generate รหัสอัตโนมัติ รูปแบบ VT-0001 (เหมือนใน flourwastetype_save.php) ===== */
...
$res = sqlsrv_query($conn, "SELECT TypeName FROM CFP_FlourWasteType");
$existingNames = array();
...
logImportResult($conn, 'CFP_FlourWasteType', $fileName, $totalRows, $successCount, $failCount, $skipCount, $errors);

if ($successCount > 0) {
    logAction($conn, 'DATA_IMPORT', 'CFP_FlourWasteType', null, null, null, null,

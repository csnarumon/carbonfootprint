        ...
        <table id="tblCooling" class="table table-bordered table-hover align-middle" style="width:100%;font-size:0.85rem">
            <thead>
                <tr>
                    ...
                    <th>ชื่ออุปกรณ์</th>
                    <th class="cfp-col-hide" style="width:130px">ประเภทสาร</th>
                    <th class="cfp-col-hide" style="width:110px">Site</th>
                    <th class="cfp-col-hide text-end" style="width:100px">ปริมาณสาร (kg)</th>
                    <th class="cfp-col-hide text-end" style="width:80px">GWP100</th>
            ...
            <tbody>
                ...
                <tr data-status="<?php echo $r['IsActive'] ? 'ใช้งาน' : 'ปิด'; ?>"
                    ...
                    <td>
                        ...
                        <div><code style="font-size:0.7rem;color:var(--cfp-text-muted);"><?php echo htmlspecialchars($r['CoolingCode']); ?></code></div>
                    ...
                    <td class="cfp-col-hide"><?php echo htmlspecialchars($r['RefTypeName']??'—'); ?></td>
                    <td class="cfp-col-hide"><?php echo htmlspecialchars($r['SiteName']??'—'); ?></td>
                    <td class="cfp-col-hide text-end" style="font-size:0.82rem;font-weight:500;">
                        <?php echo $r['RefrigerantCharge'] !== null ? number_format((float)$r['RefrigerantCharge'], 4) : '—'; ?>
                    </td>
                    <td class="cfp-col-hide text-end" style="font-size:0.78rem;color:var(--cfp-text-muted);">
                    ...
                    <td class="cfp-col-hide text-center">
                        <div class="cfp-action-group">
                          <button class="btn btn-outline-primary btn-action me-1 cfp-act-primary" onclick="openModal(<?php echo (int)$r['CoolingID']; ?>)" title="แก้ไข"><i class="bi bi-pencil-square"></i><span class="cfp-act-label">แก้ไข</span></button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var table = $('#tblCooling').DataTable({
        ...
        drawCallback: function () { cfpInitMobileExpand('tblCooling'); }
    });

    // ✅ ซ่อน Search Box ของ DataTable (ใช้ custom แทน)
    $('#tblCooling_filter').hide();

    cfpBindMobileExpand('tblCooling');
